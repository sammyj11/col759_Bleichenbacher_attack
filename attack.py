...
def base_s_calculator(cipher_text,  num , N, e):
    ...
    while flag:
        ...
        # print("hi1", length)            
        checker = check_padding(list(modified_cipher_text.to_bytes(96, byteorder='big')))
        # print("here",i)
    ...
    while flag:
        ...
        if(len(new_interval_list)==1):
            ...
            if(new_interval_list[0][0]== new_interval_list[0][1]):
                ...
                flag = False
                p = new_interval_list[0][0]%N
                bytelist= (list(p.to_bytes(96, byteorder="big")))
...
# # print(len(encrypted_msg), "hi")
# # print( pub_key[1], pub_key[0])
...
# p=attack(encrypted_msg, pub_key[1], pub_key[0])
# # print(p)

# string = ''.join(map(chr, p))
